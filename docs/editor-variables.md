...
**1. Campo `tipoRepresentacion` del contacto** _(prioridad alta)_
...
**2. Campo `parte` del expediente** _(fallback)_
...
| **Derecho Propio**     | _(ninguno)_    | Encabezado derecho propio                      |
...
_(sin DNI ni domicilio porque el contacto no los tiene cargados)_
...
_Documento generado automáticamente — actualizar ante cambios en el editor o el modelo de resolución._
