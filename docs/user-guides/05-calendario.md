...
> **💡 Consejo**: Usa las flechas de navegación o el botón "Hoy" para moverte rápidamente entre fechas.
...
Una vez creados, gestiona tus eventos fácilmente:
