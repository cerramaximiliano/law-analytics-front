...
function readEnvFile() {
    ...
    return Object.fromEntries(fs_1["default"]
        ...
        .split("\n")
        .filter(function (line) { return line.includes("=") && !line.startsWith("#"); })
        .map(function (line) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    // 1. Navegar a cualquier ruta para inicializar el contexto del browser
                    _b.sent();
                    return [4 /*yield*/, page.request.post("".concat(BASE_URL, "/api/auth/login"), {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, page.evaluate(function (t) {
                ...
                case 7:
                    _b.sent();
                    return [4 /*yield*/, page.evaluate(function () { return localStorage.getItem("token"); })];
                case 8:
                    storedToken = _b.sent();
                    return [4 /*yield*/, page.evaluate(function () { return document.cookie.includes("auth_token"); })];
                case 9:
                    cookieToken = _b.sent();
