...
exports.waitForUnauthorizedModal =
	exports.interceptAuthMeWith401 =
	exports.interceptApiWith401 =
	exports.loginViaModal =
	exports.loginViaForm =
	exports.fillLoginForm =
	exports.API_BASE =
	exports.CREDENTIALS =
		void 0;
exports.CREDENTIALS = {
...
function fillLoginForm(page) {
	return __awaiter(this, void 0, void 0, function () {
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [4 /*yield*/, page.waitForSelector("#email-login", { state: "visible", timeout: 15000 })];
				case 1:
					_a.sent();
...
function loginViaModal(page) {
	return __awaiter(this, void 0, void 0, function () {
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [4 /*yield*/, waitForUnauthorizedModal(page)];
				case 1:
					_a.sent();
					return [4 /*yield*/, page.fill("#email-login", exports.CREDENTIALS.email)];
				case 2:
...
function interceptApiWith401(page) {
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					AUTH_PATHS = ["/api/auth/login", "/api/auth/google", "/api/auth/logout", "/api/auth/me"];
					return [
						4 /*yield*/,
						page.route("".concat(exports.API_BASE, "/api/**"), function (route) {
								...
								return __generator(this, function (_a) {
									switch (_a.label) {
										case 0:
											...
											isAuthEndpoint = AUTH_PATHS.some(function (p) {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						page.route(target, function (route) {
							return __awaiter(_this, void 0, void 0, function () {
								return __generator(this, function (_a) {
									switch (_a.label) {
										case 0:
...
function waitForUnauthorizedModal(page) {
	return __awaiter(this, void 0, void 0, function () {
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [4 /*yield*/, page.waitForSelector("text=Sesión Expirada", { state: "visible", timeout: 15000 })];
				case 1:
					_a.sent();
					return [2 /*return*/];
			}
