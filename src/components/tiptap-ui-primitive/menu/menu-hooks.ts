...
import type { ContextMenuAnchor, UseContextMenuReturn, UseMenuStoreReturn } from "@/components/tiptap-ui-primitive/menu/menu-types";
...
export function useMenuPlacement(): string {
	...
	const currentPlacement = store.useState((state: any) => state.currentPlacement?.split("-")[0] || "bottom");
