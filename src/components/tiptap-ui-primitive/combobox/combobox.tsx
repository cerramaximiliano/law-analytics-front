...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn(className)} {...({} as any)}>
      <Ariakit.Combobox
...
function ComboboxValue({ ...props }: Ariakit.ComboboxItemValueProps) {
  return <Ariakit.ComboboxItemValue data-slot="tiptap-combobox-value" {...props} />
}
