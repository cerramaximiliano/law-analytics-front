...
// ─── Types ────────────────────────────────────────────────────────────────────
import type { DragContextMenuProps, MenuItemProps, NodeChangeData } from "@/components/tiptap-ui/drag-context-menu/drag-context-menu-types";
...
import { Menu, MenuContent, MenuItem, MenuGroup, MenuGroupLabel, MenuButton } from "@/components/tiptap-ui-primitive/menu";
...
import { useCopyToClipboard, CopyToClipboardShortcutBadge } from "@/components/tiptap-ui/copy-to-clipboard-button";
import { useDeleteNode, DeleteNodeShortcutBadge } from "@/components/tiptap-ui/delete-node-button";
import { useCopyAnchorLink, CopyAnchorLinkShortcutBadge } from "@/components/tiptap-ui/copy-anchor-link-button";
import { useResetAllFormatting } from "@/components/tiptap-ui/reset-all-formatting-button";
import { useAiAsk, AskAiShortcutBadge } from "@/components/tiptap-ui/ai-ask-button";
...
// toc-node not installed
const useTocShowTitle = (_opts?: any) => ({ canToggle: false, handleToggle: () => {}, label: "", Icon: () => null });
