/**
 * ClaudeAiLogo — logo oficial de Claude.ai (SVG inline).
 *
 * Diseñado para ser drop-in replacement de iconos `iconsax-react` en contextos
 * donde se menciona a Claude.ai (landing, FAQ integraciones, planes banner,
 * /integraciones/claude-ai). Acepta props compatibles con iconsax (`size`,
