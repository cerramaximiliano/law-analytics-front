...
export const getTeamById = (teamId: string) => async (dispatch: Dispatch) => {
  try {
    dispatch({ type: SET_TEAMS_LOADING });
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}`
    );
...
export const createTeam =
  (data: CreateTeamRequest) => async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
...
export const updateTeam =
  (teamId: string, data: UpdateTeamRequest) => async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
...
export const sendInvitations =
  (teamId: string, data: SendInvitationsRequest) =>
  async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}/invitations`,
        data
      );
      ...
      const errorMessage = axios.isAxiosError(error)
        ? error.response?.data?.message || "Error al enviar invitaciones"
        : "Error desconocido";
      dispatch({
        type: SET_TEAMS_ERROR,
        payload: errorMessage,
...
export const cancelInvitation =
  (teamId: string, invitationId: string) => async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}/invitations/${invitationId}`
      );
...
export const resendInvitation =
  (teamId: string, invitationId: string) => async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}/invitations/${invitationId}/resend`
      );
...
export const updateMemberRole =
  ...
  async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}/members/${userId}/role`,
        { role }
      );
...
export const removeMember =
  (teamId: string, userId: string) => async (dispatch: Dispatch) => {
    try {
      dispatch({ type: SET_TEAMS_LOADING });
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}/members/${userId}`
      );
...
export const leaveTeam = (teamId: string) => async (dispatch: Dispatch) => {
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/api/groups/${teamId}/leave`
    );
    ...
    const errorMessage = axios.isAxiosError(error)
      ? error.response?.data?.message || "Error al abandonar equipo"
      : "Error desconocido";
    return { success: false, message: errorMessage };
  }
};
...
export const verifyInvitation = async (
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/api/groups/invitations/verify/${token}`
    );
    return response.data;
  } catch (error) {
    const errorMessage = axios.isAxiosError(error)
      ? error.response?.data?.message || "Error al verificar invitación"
      : "Error desconocido";
...
export const acceptInvitation = async (
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/api/groups/invitations/accept/${token}`,
      data || {}
    );
    return response.data;
  } catch (error) {
...
export const declineInvitation = async (
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/api/groups/invitations/decline/${token}`
    );
    return response.data;
  } catch (error) {
    const errorMessage = axios.isAxiosError(error)
 ...
 */
export const initializeTeamFromStorage =
  () => async (dispatch: Dispatch, getState: any) => {
    const storedTeamId = localStorage.getItem("activeTeamId");
    const storedRole = localStorage.getItem("activeTeamRole") as
      | TeamRole
      | "owner"
      | null;
