...
const FAQS: FaqItem[] = [
	{
		...
		answer:
			"Tenés un plan Gratuito para siempre con 5 causas activas. Estándar ($7.99/mes) llega a 50 causas, Pro ($14.99/mes) a 200 y Premium ($29.99/mes) a 500 — todos con integraciones PJN/MEV, escritos con IA y más. Podés probar cualquier plan sin tarjeta y cancelar cuando quieras.",
	},
	{
		id: "security",
