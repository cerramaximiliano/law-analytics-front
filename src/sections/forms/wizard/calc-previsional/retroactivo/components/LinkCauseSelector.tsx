		...
		<>
			...
			>
				...
				<DialogContent sx={{ p: 2.5, width: "100%", overflow: "hidden" }}>
					...
					<SimpleBar sx={{ height: "420px", width: "100%", overflowX: "hidden", overflowY: "auto" }}>
									...
									>
										<Stack spacing={1.5}>
											...
											<Stack
												direction="row"
												spacing={2}
												sx={{ color: "text.secondary", bgcolor: theme.palette.background.default, p: 1, borderRadius: 1 }}
											>
