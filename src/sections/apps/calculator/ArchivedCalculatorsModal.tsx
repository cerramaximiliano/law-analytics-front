...
import { Archive, Calculator, Chart2, CloseSquare, Coin, InfoCircle, SearchNormal1, Warning2 } from "iconsax-react";
					...
					{loading ? (
						...
						<Stack alignItems="center" justifyContent="center" sx={{ flex: 1 }} spacing={1.25}>
							...
							<Typography sx={{ fontSize: "0.95rem", fontWeight: 600, letterSpacing: "-0.01em", color: "text.primary" }}>
								{searchText.trim() ? "Sin resultados" : "Sin cálculos archivados"}
							</Typography>
							<Typography sx={{ fontSize: "0.8rem", color: "text.secondary", letterSpacing: "-0.005em", textAlign: "center" }}>
								{searchText.trim() ? `No se encontraron cálculos para "${searchText.trim()}".` : "Los elementos archivados aparecerán acá."}
							</Typography>
						</Stack>
					) : (
						<Box
