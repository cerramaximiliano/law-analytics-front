...
const LinkPostalTrackingToFolder = ({ open, onClose, trackingId, currentFolderId }: Props) => {
	...
	return (
		...
		>
								...
								filteredFolders.map((folder: Folder) => {
									...
									return (
										<Box
											...
											sx={{
												border: "1px solid",
												borderColor: isSelected ? theme.palette.primary.main : isCurrent ? theme.palette.success.main : "divider",
												borderRadius: 1,
												p: 2,
												cursor: "pointer",
												bgcolor: isSelected
										...
										>
											<Stack direction="row" alignItems="center" spacing={1}>
												...
												{isSelected && <TickCircle variant="Bold" size={22} style={{ color: theme.palette.primary.main }} />}
											</Stack>
										</Box>
									);
								})
			...
			<DialogActions sx={{ p: 2.5, bgcolor: theme.palette.background.default, borderTop: `1px solid ${theme.palette.divider}` }}>
