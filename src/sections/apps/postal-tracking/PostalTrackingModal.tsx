	...
	return (
		...
		>
					...
					<Stack direction="row" alignItems="center" spacing={1.5} flex={1}>
						...
						<Stack spacing={0.5}>
							...
							<Typography variant="body2" color="textSecondary">
								{tracking ? "Modificá la etiqueta o etiquetas del seguimiento" : "Ingresá el código y número del envío postal"}
							</Typography>
						</Stack>
					</Stack>
					<Box
			...
			<DialogContent sx={{ p: 3 }}>
				<AddEditPostalTracking tracking={tracking} onCancel={handleClose} showSnackbar={showSnackbar} />
			</DialogContent>
		</Dialog>
	);
};
