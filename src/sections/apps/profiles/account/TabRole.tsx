...
import { Box, Button, Card, CardContent, Grid, IconButton, Stack, Tooltip, Typography, Alert, Chip, Skeleton } from "@mui/material";
				...
				<Grid item xs={12}>
					<MainCard>
						<Stack spacing={3} alignItems="center" sx={{ py: 4 }}>
								...
								<CardContent>
									<Stack spacing={2}>
										...
										<Stack direction="row" justifyContent="space-between" alignItems="center">
											...
											<Chip label={getRoleLabel(userRole)} color={getRoleColor(userRole)} size="small" variant="filled" />
										</Stack>
										...
										<Stack direction="row" justifyContent="space-between" alignItems="center">
											...
											<Typography variant="body2">{(activeTeam?.members?.length || 0) + 1} miembros</Typography>
										</Stack>
									</Stack>
								</CardContent>
							</Card>

							<Alert severity="info" sx={{ maxWidth: 500 }} icon={<Information size={20} variant="Bulk" />}>
							...
							<Button variant="outlined" color="error" startIcon={<Logout size={18} />} onClick={() => setShowLeaveDialog(true)}>
								Abandonar Equipo
							</Button>
						</Stack>
					</MainCard>
					...
					<MainCard>
						<Stack spacing={3} alignItems="center" sx={{ py: 4 }}>
							...
							<Typography variant="body1" color="text.secondary" textAlign="center" maxWidth={500}>
								La funcionalidad de equipos te permite invitar colaboradores a tu cuenta y compartir recursos como causas, contactos,
								calculadoras y más.
							</Typography>
							<Alert severity="warning" sx={{ maxWidth: 500 }}>
								Tu plan actual ({planName}) no incluye la gestión de equipos. Actualiza a un plan Estándar o Premium para acceder a esta
								funcionalidad.
								<br />
								<strong>Límites por plan:</strong> Estándar: hasta 5 miembros · Premium: hasta 20 miembros.
							</Alert>
							<Button variant="contained" size="large" onClick={() => navigate("/suscripciones/tables")}>
				...
				<Grid item xs={12}>
					<MainCard>
						<Stack spacing={3} alignItems="center" sx={{ py: 4 }}>
							...
							<Typography variant="body1" color="text.secondary" textAlign="center" maxWidth={500}>
								Crea un equipo para invitar colaboradores y compartir recursos. Puedes tener hasta {maxTeamMembers} miembros en tu plan{" "}
								{planName}.
							</Typography>
							<Button variant="contained" size="large" startIcon={<Add size={20} />} onClick={() => setShowCreateDialog(true)}>
								Crear Equipo
							</Button>
						</Stack>
					</MainCard>
					...
					<CardContent sx={{ py: 1.5, "&:last-child": { pb: 1.5 } }}>
						...
						>
							<Box>
								...
								<Typography variant="caption" color="text.secondary">
									{isOwner ? "Eliminar el equipo removerá a todos los miembros." : "Perderás acceso a los recursos compartidos."}
								</Typography>
							</Box>
							<Button
								variant="outlined"
