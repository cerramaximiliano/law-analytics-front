...
const AutomaticStep = () => {
  ...
  useEffect(() => {
    ...
    setAutomaticValues();
  }, [values.folderJuris, values.expedientNumber, values.expedientYear, touched.folderJuris, touched.expedientNumber, touched.expedientYear, formSubmitAttempted.current]);
