            ...
            <>
              <Alert severity="warning">
                ...
                <ul style={{ margin: "8px 0 0 0", paddingLeft: 20 }}>
                  ...
                  <li><strong>Los recursos que migraste al unirte permanecerán en el equipo</strong> (no podrás recuperarlos)</li>
                  <li><strong>Los recursos que creaste en el equipo también permanecerán</strong> (son propiedad del equipo)</li>
