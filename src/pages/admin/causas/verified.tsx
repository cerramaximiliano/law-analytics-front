									...
									{loading ? (
										...
										<TableRow>
											<TableCell colSpan={11} align="center" sx={{ py: 3 }}>
												<Typography variant="subtitle1">No hay causas disponibles para {getFueroLabel(fuero)}</Typography>
											</TableCell>
										</TableRow>
									) : (
