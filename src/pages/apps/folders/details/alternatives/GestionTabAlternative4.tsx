...
import CalcTableEnhanced from "../components/CalcTableEnhanced";
...
interface GestionTabAlternative4Props {
	folder: ExtendedFolderData;
	isDetailedView: boolean;
}

const GestionTabAlternative4: React.FC<GestionTabAlternative4Props> = ({ folder, isDetailedView }) => {
				...
				<>
					<Box sx={{ width: "100%", p: 3 }}>
						...
						<TabPanel value={value} index={0}>
							<CalcTableEnhanced
								title="Cálculos"
								folderData={{ folderName: folder.folderName, monto: folder.monto || folder.amount || 0 }}
							/>
						</TabPanel>
						<TabPanel value={value} index={1}>
							<Members title="Miembros" membersData={folder.members || []} isLoader={false} folderId={folder._id} />
						</TabPanel>
						<TabPanel value={value} index={2}>
							<TaskList title="Tareas" folderName={folder.folderName} />
						</TabPanel>
					</Box>
					<Drawer
						anchor="left"
...
export default GestionTabAlternative4;
